function [] = arm2link_state_obstacle_plot( x, u, x_tar, x_obs)
...
% Plot target
plot(x_tar(1), x_tar(2), '+', 'LineWidth', 5, 'Markersize', 4,'color', darkred);
plot(x_obs(1), x_obs(2), 'o', 'LineWidth', 7, 'Markersize', 4, 'color', orange);
